...
bool UUI_SelectTip::Initialize()
{
	...
	this->M_UButtonCancel = this->GetWidgetComponent<UButton>(this, "Cancel");
...
UButton* UUI_SelectTip::GetCancelButton()
{
	return this->M_UButtonCancel;
}

UUI_SelectTip* UUI_SelectTip::CreateSelectTip(UWidget* _Owner)
{
	UUI_SelectTip* Widget = CreateWidget<UUI_SelectTip>(_Owner, LoadClass<UUI_SelectTip>(0,
		TEXT("WidgetBlueprint'/Game/Resource/BP/Game/UI/UI_Tip/UI_SelectTip.UI_SelectTip_C'")));
